...
namespace log4net.ElasticSearch
{
    ...
    /// </para>
    /// <para>
    /// The <see cref="JsonFileAppender"/> supports pluggable file locking models via
    /// the <see cref="LockingModel"/> property.
    /// The default behavior, implemented by <see cref="JsonFileAppender.ExclusiveLock"/> 
    /// is to obtain an exclusive write lock on the file until this appender is closed.
    /// The alternative models only hold a
    /// write lock while the appender is writing a logging event (<see cref="JsonFileAppender.MinimalLock"/>)
    /// or synchronize by using a named system wide Mutex (<see cref="JsonFileAppender.InterProcessLock"/>).
    /// </para>
    /// <para>
	...
	/// <author>Niall Daley</author>
#endif
    public class JsonFileAppender : JsonTextWriterAppender
    {
        ...
        /// <remarks>
        /// <para>
        /// Base class for the locking models available to the <see cref="JsonFileAppender"/> derived loggers.
        /// </para>
        /// </remarks>
        public abstract class LockingModelBase
        {
            private JsonFileAppender m_appender = null;
            ...
            /// <summary>
            /// Gets or sets the <see cref="JsonFileAppender"/> for this LockingModel
            /// </summary>
            /// <value>
            /// The <see cref="JsonFileAppender"/> for this LockingModel
            /// </value>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public JsonFileAppender CurrentAppender
            {
        ...
        /// is considerably slower than <see cref="JsonFileAppender.ExclusiveLock"/> but allows 
        ...
        public JsonFileAppender(ILayout layout, string filename, bool append)
        {
            Layout = layout;
            File = filename;
            AppendToFile = append;
        ...
        public JsonFileAppender(ILayout layout, string filename) : this(layout, filename, true)
        {
        }
...
#if NETCF
		/// <summary>
		/// Gets or sets the <see cref="JsonFileAppender.LockingModel"/> used to handle locking of the file.
		/// </summary>
		/// <value>
		/// The <see cref="JsonFileAppender.LockingModel"/> used to lock the file.
		/// </value>
		/// <remarks>
		/// <para>
		/// Gets or sets the <see cref="JsonFileAppender.LockingModel"/> used to handle locking of the file.
		/// </para>
		/// <para>
        /// There are two built in locking models, <see cref="JsonFileAppender.ExclusiveLock"/> and <see cref="JsonFileAppender.MinimalLock"/>.
		...
		/// </para>
		/// <para>
		/// The default locking model is the <see cref="JsonFileAppender.ExclusiveLock"/>.
		/// </para>
		/// </remarks>
#else
        /// <summary>
        ...
        /// </para>
        /// <para>
        /// There are three built in locking models, <see cref="JsonFileAppender.ExclusiveLock"/>, <see cref="JsonFileAppender.MinimalLock"/> and <see cref="JsonFileAppender.InterProcessLock"/> .
        /// The first locks the file from the start of logging to the end, the 
        /// second locks only for the minimal amount of time when logging each message
        /// and the last synchronizes processes using a named system wide Mutex.
        /// </para>
        ...
        /// </remarks>
#endif
        public JsonFileAppender.LockingModelBase LockingModel
        {
        ...
        override public void ActivateOptions()
        {
            ...
            {
                m_lockingModel = new JsonFileAppender.ExclusiveLock();
            }
            ...
            {
                LogLog.Warn(declaringType, "JsonFileAppender: File option not set for appender [" + Name + "].");
                LogLog.Warn(declaringType, "JsonFileAppender: Are you using JsonFileAppender instead of ConsoleAppender?");
            }
        }
        ...
        /// </summary>
        private JsonFileAppender.LockingStream m_stream = null;

        /// <summary>
        /// The locking model to use
        /// </summary>
        private JsonFileAppender.LockingModelBase m_lockingModel = new JsonFileAppender.ExclusiveLock();
        ...
        /// <summary>
        /// The fully qualified type of the JsonFileAppender class.
        /// </summary>
        /// <remarks>
        /// Used by the internal logger to record the Type of the
        /// log message.
        /// </remarks>
        private readonly static Type declaringType = typeof(JsonFileAppender);
