...
namespace log4net.ElasticSearch
{
    ...
    public class JsonTextWriterAppender : JsonAppenderSkeleton
    {
        #region Public Instance Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonTextWriterAppender" /> class.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Default constructor.
        /// </para>
        /// </remarks>
        public JsonTextWriterAppender()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonTextWriterAppender" /> class and
        ...
        public JsonTextWriterAppender(ILayout layout, Stream os) : this(layout, new StreamWriter(os))
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonTextWriterAppender" /> class and sets
        ...
        /// </remarks>
        [Obsolete("Instead use the default constructor and set the Layout & Writer properties")]
        public JsonTextWriterAppender(ILayout layout, TextWriter writer)
        {
            Layout = layout;
            Writer = writer;
        }
        ...
        override public IErrorHandler ErrorHandler
        {
            ...
            set
            {
                lock (this)
                {
                    if (value == null)
                    {
                        LogLog.Warn(declaringType, "JsonTextWriterAppender: You have tried to set a null error-handler.");
                    }
                    else
                    {
        ...
        /// <summary>
        /// The fully qualified type of the JsonTextWriterAppender class.
        /// </summary>
        /// <remarks>
        /// Used by the internal logger to record the Type of the
        /// log message.
        /// </remarks>
        private readonly static Type declaringType = typeof(JsonTextWriterAppender);
