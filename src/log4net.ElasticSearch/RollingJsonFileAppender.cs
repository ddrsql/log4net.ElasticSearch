...
namespace log4net.ElasticSearch
{
    ...
    /// <remarks>
    /// <para>
    /// RollingJsonFileAppender can roll log files based on size or date or both
    ...
    /// 
    /// <para>
    /// The <see cref="RollingJsonFileAppender"/> extends the <see cref="FileAppender"/> and
    ...
    public class RollingJsonFileAppender : JsonFileAppender
    {
        #region Public Enums
		...
		public enum RollingMode
        {
            ...
            /// <c>false</c> on the <c>RollingJsonFileAppender</c>, otherwise
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RollingJsonFileAppender" /> class.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Default constructor.
        /// </para>
        /// </remarks>
        public RollingJsonFileAppender()
        {
        }
        ...
        /// <see cref="RollingJsonFileAppender.UniversalDateTime"/>.
        /// </summary>
        /// <value>
        /// An implementation of the <see cref="RollingJsonFileAppender.IDateTime"/> interface which returns the current date and time.
        /// </value>
        /// <remarks>
        /// <para>
        /// Gets or sets the <see cref="RollingJsonFileAppender.IDateTime"/> used to return the current date and time.
        /// </para>
        /// <para>
        /// There are two built strategies for determining the current date and time, 
        /// <see cref="RollingJsonFileAppender.LocalDateTime"/>
        /// and <see cref="RollingJsonFileAppender.UniversalDateTime"/>.
        /// </para>
        /// <para>
        /// The default strategy is <see cref="RollingJsonFileAppender.LocalDateTime"/>.
        /// </para>
        /// </remarks>
#else
        /// <summary>
        ...
        /// <summary>
        /// The fully qualified type of the RollingJsonFileAppender class.
        /// </summary>
        /// <remarks>
        /// Used by the internal logger to record the Type of the
        /// log message.
        /// </remarks>
        private readonly static Type declaringType = typeof(RollingJsonFileAppender);
        ...
        /// <remarks>
        /// <para>
        /// Handles append time behavior for RollingJsonFileAppender.  This checks
            ...
            lock (this)
            {
                ...
                else
                {
                    if (LogLog.IsErrorEnabled)
                    {
                        ...
                        {
                            LogLog.Error(declaringType, "RollingJsonFileAppender: INTERNAL ERROR. Append is False but OutputFile [" + fileName + "] already exists.");
                        }
                    }
                }
        ...
        /// <summary>
        /// This interface is used to supply Date/Time information to the <see cref="RollingJsonFileAppender"/>.
        /// </summary>
        /// <remarks>
        /// This interface is used to supply Date/Time information to the <see cref="RollingJsonFileAppender"/>.
