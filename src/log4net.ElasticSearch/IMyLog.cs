...
{
    /// <summary>
    /// The IMyLog interface is use by application to log messages into
    ...
    /// <code lang="C#">
    /// IMyLog log = LogManager.GetLogger("application-log");
    /// 
    ...
    public interface IMyLog : ILoggerWrapper
    {
        ...
        /// </para>
        /// <para> For some IMyLog interface <c>log</c>, when you write:</para>
        /// <code lang="C#">
        ...
        /// </value>
        /// <remarks>
        /// For more information see <see cref="IMyLog.IsDebugEnabled"/>.
        /// </remarks>
        /// <seealso cref="M:Info(object)"/>
        /// <seealso cref="M:InfoFormat(IFormatProvider, string, object[])"/>
        /// <seealso cref="IMyLog.IsDebugEnabled"/>
