...
namespace log4net.ElasticSearch
{
    ...
    /// </para>
    /// <para>
    /// See the <see cref="IMyLog"/> interface for more details.
    /// </para>
    /// </remarks>
    /// <example>Simple example of logging messages
    /// <code lang="C#">
    /// IMyLog log = KanqLogManager.GetLogger("application-log");
    /// 
    ...
    public sealed class MyLogManager
    {
        #region Private Instance Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="MyLogManager" /> class. 
        /// </summary>
        /// <remarks>
        ...
        /// repository.
        /// </returns>
        public static IMyLog Exists(string repository, string name)
        {
        ...
        /// </returns>
        public static IMyLog Exists(Assembly repositoryAssembly, string name)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers.</returns>
        public static IMyLog[] GetCurrentLoggers(string repository)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers.</returns>
        public static IMyLog[] GetCurrentLoggers(Assembly repositoryAssembly)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static IMyLog GetLogger(string repository, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static IMyLog GetLogger(Assembly repositoryAssembly, string name)
        {
            return WrapLogger(LoggerManager.GetLogger(repositoryAssembly, name));
        }

        /// <summary>
        /// Shorthand for <see cref="M:KanqLogManager.GetLogger(string)"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static IMyLog GetLogger(string repository, Type type)
        {
        ...
        /// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
        /// <returns>The logger with the name specified.</returns>
        public static IMyLog GetLogger(Assembly repositoryAssembly, Type type)
        {
