...
namespace log4net.ElasticSearch
{
    ...
    public abstract class JsonAppenderSkeleton : IAppender, IBulkAppender, IOptionHandler, IFlushable
    {
        ...
        /// </remarks>
        protected JsonAppenderSkeleton()
        {
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="JsonAppenderSkeleton"/> provides a default 
        ...
        private CustomDataContractResolver resolver;
        ...
        virtual public void ActivateOptions()
        {
            ...
            resolver = new CustomDataContractResolver
            {
                FieldNameChanges = overrides,
                FieldValueReplica = fieldValueReplicas,
            };
        }
        public virtual void AddFieldNameOverride(FieldNameOverride fieldNameOverride)
        {
            fieldNameOverrides.Add(fieldNameOverride);
        }

        public virtual void AddFieldValueReplica(FieldValueReplica fieldValueReplica)
        {
...
//#endif
        ...
        /// <summary>
        /// Subclasses of <see cref="JsonAppenderSkeleton"/> should implement this method 
        ...
        virtual protected bool PreAppendCheck()
        {
            ...
            {
                ErrorHandler.Error("JsonAppenderSkeleton: No layout set for the appender named [" + m_name + "].");
                return false;
            }
        ...
        protected void RenderLoggingEvent(TextWriter writer, LoggingEvent loggingEvent)
        {
            ...
            //    m_layout.Format(writer, loggingEvent);
            //}
            var logEventList = logEvent.CreateMany(new[] { loggingEvent });
            var logStr = logEventList.First().ToJson(resolver);
        ...
        /// <summary>
        /// The fully qualified type of the JsonAppenderSkeleton class.
        /// </summary>
        /// <remarks>
        /// Used by the internal logger to record the Type of the
        /// log message.
        /// </remarks>
        private readonly static Type declaringType = typeof(JsonAppenderSkeleton);
